...
// Mutate calls f(ctx, m).
func (f MonitorContractFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MonitorContractMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MonitorContractMutation", m)
}
...
// function as ParsedEventsLog mutator.
type ParsedEventsLogFunc func(context.Context, *ent.ParsedEventsLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ParsedEventsLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ParsedEventsLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ParsedEventsLogMutation", m)
}
